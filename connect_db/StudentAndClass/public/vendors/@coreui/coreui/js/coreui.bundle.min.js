...
!function(t, e) {
      ...
      , tt = function() {
        ...
        n._loadPage = function(t) {
            ...
            r.onload = function(e) {
                if (200 === r.status) {
                    ...
                    n.innerHTML = "",
                    n.appendChild(a),
                    (c = document.querySelectorAll(".view-script")).length && c.forEach((function(t) {
                        t.remove()
                    }
                    )),
                    l.length && o(l),
        ...
        n._addEventListeners = function() {
            ...
            F.on(document, "click.coreui.asyncLoad.data-api", J, (function(e) {
                ...
                n.classList.contains("c-sidebar-nav-dropdown-toggle") || "#" === n.getAttribute("href") || t._update(n)
            }
            ))
        }
        ,
    ...
    if (et) {
        var nt = et.fn[V];
        et.fn[V] = tt.jQueryInterface,
        et.fn[V].Constructor = tt,
        et.fn[V].noConflict = function() {
            return et.fn[V] = nt,
            tt.jQueryInterface
        }
    }
    var it = "coreui.alert"
      , ot = function() {
        ...
        n._destroyElement = function(t) {
            ...
            F.trigger(t, "closed.coreui.alert")
        }
        ,
        t.jQueryInterface = function(e) {
            return this.each((function() {
    ...
    if (rt) {
        var st = rt.fn.alert;
        rt.fn.alert = ot.jQueryInterface,
        rt.fn.alert.Constructor = ot,
        rt.fn.alert.noConflict = function() {
            return rt.fn.alert = st,
            ot.jQueryInterface
        }
    }
    var at = {
      ...
      , pt = function() {
        ...
        return n.toggle = function() {
            ...
            if (n) {
                ...
                if (i && "radio" === i.type) {
                    if (i.checked && this._element.classList.contains(ct))
                        t = !1;
                    else {
                    ...
                    if (t) {
                        if (i.hasAttribute("disabled") || n.hasAttribute("disabled") || i.classList.contains(ut) || n.classList.contains(ut))
                            return;
                        i.checked = !this._element.classList.contains(ct),
                        F.trigger(i, "change")
                    }
                    i.focus(),
                    e = !1
            ...
            e && this._element.setAttribute("aria-pressed", !this._element.classList.contains(ct)),
            t && this._element.classList.toggle(ct)
        }
        ,
        n.dispose = function() {
            C(this._element, lt),
    ...
    if (gt) {
        var mt = gt.fn.button;
        gt.fn.button = pt.jQueryInterface,
        gt.fn.button.Constructor = pt,
        gt.fn.button.noConflict = function() {
            return gt.fn.button = mt,
            pt.jQueryInterface
        }
    }
    function vt(t) {
    ...
    var bt = {
      ...
      , Dt = function() {
        ...
        n.pause = function(t) {
            t || (this._isPaused = !0),
            at.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (g(this._element),
            this.cycle(!0)),
        ...
        n.to = function(t) {
            ...
            if (!(t > this._items.length - 1 || t < 0))
                if (this._isSliding)
                    F.one(this._element, Ct, (function() {
                        return e.to(t)
                    }
                    ));
                else {
        ...
        n._addTouchEventListeners = function() {
            var t = this
              ...
              , n = function(e) {
                t._pointerEvent && xt[e.pointerType.toUpperCase()] && (t.touchDeltaX = e.clientX - t.touchStartX),
                t._handleSwipe(),
        ...
        n._getItemIndex = function(t) {
            return this._items = t && t.parentNode ? at.find(".carousel-item", t.parentNode) : [],
        ...
        n._slide = function(t, e) {
            var n, i, o, r = this, s = at.findOne(At, this._element), a = this._getItemIndex(s), l = e || s && this._getItemByDirection(t, s), u = this._getItemIndex(l), f = Boolean(this._interval);
            if (t === kt ? (n = "carousel-item-left",
            i = "carousel-item-next",
            o = "left") : (n = "carousel-item-right",
            i = "carousel-item-prev",
            o = "right"),
            l && l.classList.contains(St))
                this._isSliding = !1;
    ...
    F.on(document, "click.coreui.carousel.data-api", "[data-slide], [data-slide-to]", Dt.dataApiClickHandler),
    ...
    if (jt) {
        var Nt = jt.fn[yt];
        jt.fn[yt] = Dt.jQueryInterface,
        jt.fn[yt].Constructor = Dt,
        jt.fn[yt].noConflict = function() {
            return jt.fn[yt] = Nt,
            Dt.jQueryInterface
        }
    }
    var It = "class-toggler"
      ...
      , Xt = function() {
        ...
        n.toggle = function() {
            ...
            this._config.responsive ? n.forEach((function(n) {
                t._updateResponsiveClassNames(n).filter((function(t) {
                    ...
                    t.remove(),
                    t._customEvent(Wt, e, !1, n)
                }
                )) : (t._config.addClass = n,
                t.add(),
                t._customEvent(Wt, e, !0, n))
            }
            )) : n.forEach((function(n) {
                e.classList.contains(n) ? (t._config.removeClass = n,
                t.remove(),
                t._customEvent(Wt, e, !1, n)) : (t._config.addClass = n,
                t.add(),
                t._customEvent(Wt, e, !0, n))
            }
            ))
        ...
        ,
        n._getConfig = function(t) {
            return t = o(o(o({}, this.constructor.Default), bt.getDataAttributes(this._element)), t),
            _(It, t, this.constructor.DefaultType),
            t
        }
        ,
    ...
    F.on(document, "click.coreui.class-toggler.data-api", Yt, (function(t) {
        ...
        t.stopPropagation();
        var e = t.target;
        e.classList.contains("c-class-toggler") || (e = e.closest(Yt)),
        "undefined" != typeof e.dataset.addClass && Xt.classTogglerInterface(e, "add"),
        "undefined" != typeof e.dataset.removeClass && Xt.classTogglerInterface(e, "remove"),
        "undefined" != typeof e.dataset.toggleClass && Xt.classTogglerInterface(e, "toggle"),
        "undefined" != typeof e.dataset.class && Xt.classTogglerInterface(e, "class")
    }
    ));
    var Bt = L();
    if (Bt) {
        var Ut = Bt.fn[It];
        Bt.fn[It] = Xt.jQueryInterface,
        Bt.fn[It].Constructor = Xt,
        Bt.fn[It].noConflict = function() {
            return Bt.fn[It] = Ut,
            Xt.jQueryInterface
        }
    }
    var qt = "collapse"
      ...
      , te = function() {
        function t(t, e) {
            ...
            this._element = t,
            this._config = this._getConfig(e),
            this._triggerArray = at.find(Zt + '[href="#' + t.id + '"],[data-toggle="collapse"][data-target="#' + t.id + '"]');
        ...
        n.show = function() {
            ...
            if (!this._isTransitioning && !this._element.classList.contains(zt)) {
                ...
                if (n) {
                    ...
                    if ((i = r[0] ? O(r[0], Qt) : null) && i._isTransitioning)
                        return
                }
                if (!F.trigger(this._element, "show.coreui.collapse").defaultPrevented) {
                    ...
                    F.one(this._element, c, (function() {
                        ...
                        e._element.classList.add(Kt, zt),
                        e._element.style[s] = "",
                        e.setTransitioning(!1),
                        F.trigger(e._element, "shown.coreui.collapse")
                    }
                    )),
                    v(this._element, l),
        ...
        n.hide = function() {
            ...
            if (!this._isTransitioning && this._element.classList.contains(zt) && !F.trigger(this._element, "hide.coreui.collapse").defaultPrevented) {
                ...
                E(this._element),
                this._element.classList.add($t),
                this._element.classList.remove(Kt, zt);
                var n = this._triggerArray.length;
                if (n > 0)
                    for (var i = 0; i < n; i++) {
                        var o = this._triggerArray[i]
                          , r = d(o);
                        r && !r.classList.contains(zt) && (o.classList.add(Gt),
                ...
                F.one(this._element, c, (function() {
                    ...
                    t._element.classList.remove($t),
                    t._element.classList.add(Kt),
                    F.trigger(t._element, "hidden.coreui.collapse")
                }
                )),
                v(this._element, s)
            }
        ...
        ,
        n._getConfig = function(t) {
            return (t = o(o({}, Ft), t)).toggle = Boolean(t.toggle),
            _(qt, t, Vt),
            t
        }
        ,
        ...
        n._addAriaAndCollapsedClass = function(t, e) {
            if (t && e.length) {
                ...
                e.forEach((function(t) {
                    n ? t.classList.remove(Gt) : t.classList.add(Gt),
        ...
        t.collapseInterface = function(e, n) {
            var i = O(e, Qt)
              , r = o(o(o({}, Ft), bt.getDataAttributes(e)), "object" == typeof n && n ? n : {});
    ...
    if (ee) {
        var ne = ee.fn[qt];
        ee.fn[qt] = te.jQueryInterface,
        ee.fn[qt].Constructor = te,
        ee.fn[qt].noConflict = function() {
            return ee.fn[qt] = ne,
            te.jQueryInterface
        }
    }
    ...
    function Ce(t) {
        if (!be(t) || "fixed" === Le(t).position)
            return null;
        var e = t.offsetParent;
        if (e) {
            var n = ke(e);
            if ("body" === me(e) && "static" === Le(e).position && "static" !== Le(n).position)
                return n
        }
        return e
    }
    ...
    function Ie(t) {
        ...
        return a ? Object.assign(Object.assign({}, b), {}, ((_ = {})[g] = d ? "0" : "",
        _[p] = h ? "0" : "",
        _.transform = (m.devicePixelRatio || 1) < 2 ? "translate(" + u + "px, " + f + "px)" : "translate3d(" + u + "px, " + f + "px, 0)",
        _)) : Object.assign(Object.assign({}, b), {}, ((e = {})[g] = d ? f + "px" : "",
        e[p] = h ? u + "px" : "",
        e.transform = "",
        e))
    }
    ...
    function $e(t) {
        var e, n = t.reference, i = t.element, o = t.placement, r = o ? ye(o) : null, s = o ? Ke(o) : null, a = n.x + n.width / 2 - i.width / 2, l = n.y + n.height / 2 - i.height / 2;
        switch (r) {
        case ie:
            e = {
                x: a,
    ...
    function en(t, e, n) {
        ...
        be(e) ? ((l = Ye(e)).x += e.clientLeft,
        l.y += e.clientTop) : o && (l.x = Be(o))),
        {
        ...
        defaultModifiers: [{
            ...
            fn: function(t) {
                ...
                Object.keys(e.elements).forEach((function(t) {
                    var n = e.styles[t] || {}
                      , i = e.attributes[t] || {}
                      , o = e.elements[t];
                    be(o) && me(o) && (Object.assign(o.style, n),
            ...
            effect: function(t) {
                ...
                function() {
                    Object.keys(e.elements).forEach((function(t) {
                        ...
                        be(i) && me(i) && (Object.assign(i.style, r),
            ...
            fn: function(t) {
                ...
                if (!e.modifiersData[i]._skip) {
                    ...
                    e.placement !== T && (e.modifiersData[i]._skip = !0,
                    e.placement = T,
                    e.reset = !0)
                }
            },
            ...
            phase: "main",
            fn: function(t) {
                var e, n = t.state, i = t.name, o = n.elements.arrow, r = n.modifiersData.popperOffsets, s = ye(n.placement), a = Ae(s), l = [se, re].indexOf(s) >= 0 ? "height" : "width";
                if (o && r) {
            ...
            effect: function(t) {
                var e = t.state
                  ...
                  , s = n.padding
                  , a = void 0 === s ? 0 : s;
                null != r && ("string" != typeof r || (r = e.elements.popper.querySelector(r))) && Ee(e.elements.popper, r) && (e.elements.arrow = r,
      ...
      , Cn = function() {
            ...
            if (!(this._element.disabled || this._element.classList.contains(yn) || this._menu.classList.contains(wn))) {
                ...
                if (!F.trigger(e, "show.coreui.dropdown", n).defaultPrevented) {
                    if (!this._inNavbar && !this._inHeader) {
                        ...
                        var i = this._element;
                        "parent" === this._config.reference ? i = e : m(this._config.reference) && (i = this._config.reference,
                    ...
                    if ("ontouchstart"in document.documentElement && !e.closest(".c-header-nav"))
                    ...
                    bt.toggleClass(this._menu, wn),
                    bt.toggleClass(e, wn),
                    F.trigger(e, "shown.coreui.dropdown", n)
                }
            }
        }
        ,
        n.hide = function() {
            if (!this._element.disabled && !this._element.classList.contains(yn) && this._menu.classList.contains(wn)) {
                ...
                F.trigger(e, mn, n).defaultPrevented || (this._popper && this._popper.destroy(),
                bt.toggleClass(this._menu, wn),
                bt.toggleClass(e, wn),
                F.trigger(e, vn, n))
            }
        ...
        n._getConfig = function(t) {
            return t = o(o(o({}, this.constructor.Default), bt.getDataAttributes(this._element)), t),
            _(ln, t, this.constructor.DefaultType),
            t
        }
        ,
        ...
        n._getPlacement = function() {
            ...
            this._menu.classList.contains(En) && (e = "top-end")) : t.classList.contains("dropright") ? e = "right-start" : t.classList.contains("dropleft") ? e = "left-start" : this._menu.classList.contains(En) && (e = "bottom-end"),
            e
        }
        ,
        ...
        t.clearMenus = function(e) {
            if (!e || 2 !== e.button && ("keyup" !== e.type || "Tab" === e.key))
                for (var n = at.find(Ln), i = 0, o = n.length; i < o; i++) {
        ...
        t.dataApiKeydownHandler = function(e) {
            if (!(/input|textarea/i.test(e.target.tagName) ? e.key === hn || e.key !== fn && (e.key !== pn && e.key !== dn || e.target.closest(Tn)) : !gn.test(e.key)) && (e.preventDefault(),
            e.stopPropagation(),
            !this.disabled && !this.classList.contains(yn))) {
                var n = t.getParentFromElement(this)
                  , i = n.classList.contains(wn);
                if (e.key === fn)
                    return (this.matches(Ln) ? this : at.prev(this, Ln)[0]).focus(),
                    void t.clearMenus();
                if (i && e.key !== hn) {
    ...
    F.on(document, bn, Ln, Cn.dataApiKeydownHandler),
    F.on(document, bn, Tn, Cn.dataApiKeydownHandler),
    F.on(document, _n, Cn.clearMenus),
    F.on(document, "keyup.coreui.dropdown.data-api", Cn.clearMenus),
    F.on(document, _n, Ln, (function(t) {
        t.preventDefault(),
        t.stopPropagation(),
    ...
    var xn = "modal"
      ...
      , Kn = function() {
        function t(t, e) {
            this._config = this._getConfig(e),
            this._element = t,
            this._dialog = at.findOne(".modal-dialog", t),
            this._backdrop = null,
            this._isShown = !1,
        ...
        n.show = function(t) {
            ...
            if (!this._isShown && !this._isTransitioning) {
                ...
                F.on(this._element, Yn, '[data-dismiss="modal"]', (function(t) {
                    return e.hide(t)
                }
                )),
        ...
        n.hide = function(t) {
            ...
            this._isShown && !this._isTransitioning) && !F.trigger(this._element, "hide.coreui.modal").defaultPrevented) {
                ...
                F.off(this._element, Yn),
                F.off(this._dialog, Bn),
                n) {
        ...
        n._showElement = function(t) {
            ...
            var o = function() {
                ...
                F.trigger(e._element, "shown.coreui.modal", {
                    relatedTarget: t
                })
            };
            if (n) {
        ...
        n._setEscapeEvent = function() {
            ...
            this._isShown ? F.on(this._element, Xn, (function(e) {
                t._config.keyboard && e.key === Nn ? (e.preventDefault(),
                t.hide()) : t._config.keyboard || e.key !== Nn || t._triggerBackdropTransition()
            }
        ...
        n._showBackdrop = function(t) {
            ...
            if (this._isShown && this._config.backdrop) {
                ...
                F.on(this._element, Yn, (function(t) {
                    e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && e._triggerBackdropTransition()
                }
                )),
                n && E(this._backdrop),
                this._backdrop.classList.add(Qn),
                !n)
                    return void t();
                var i = p(this._backdrop);
                F.one(this._backdrop, c, t),
                v(this._backdrop, i)
        ...
        n._triggerBackdropTransition = function() {
            ...
            if ("static" === this._config.backdrop) {
                ...
                F.one(this._element, c, (function() {
                    t._element.classList.remove(Fn),
                    e || (F.one(t._element, c, (function() {
        ...
        n._setScrollbar = function() {
            ...
            if (this._isBodyOverflowing) {
                at.find(Vn).forEach((function(e) {
                    ...
                    bt.setDataAttribute(e, "padding-right", n),
                ...
                at.find(zn).forEach((function(e) {
                    ...
                    bt.setDataAttribute(e, "margin-right", n),
                    e.style.marginRight = parseFloat(i) - t._scrollbarWidth + "px"
                }
                ));
                var e = document.body.style.paddingRight
                  , n = window.getComputedStyle(document.body)["padding-right"];
                bt.setDataAttribute(document.body, "padding-right", e),
        ...
        n._resetScrollbar = function() {
            at.find(Vn).forEach((function(t) {
                ...
                "undefined" != typeof e && (bt.removeDataAttribute(t, "padding-right"),
                t.style.paddingRight = e)
            }
            )),
            at.find(".sticky-top").forEach((function(t) {
                var e = bt.getDataAttribute(t, "margin-right");
                "undefined" != typeof e && (bt.removeDataAttribute(t, "margin-right"),
                t.style.marginRight = e)
            }
            ));
            var t = bt.getDataAttribute(document.body, "padding-right");
            "undefined" == typeof t ? document.body.style.paddingRight = "" : (bt.removeDataAttribute(document.body, "padding-right"),
    ...
    if ($n) {
        var Gn = $n.fn.modal;
        $n.fn.modal = Kn.jQueryInterface,
        $n.fn.modal.Constructor = Kn,
        $n.fn.modal.noConflict = function() {
            return $n.fn.modal = Gn,
            Kn.jQueryInterface
        }
    }
        ...
        for (var o = (new window.DOMParser).parseFromString(t, "text/html"), r = Object.keys(e), s = (i = []).concat.apply(i, o.body.querySelectorAll("*")), a = function(t, n) {
            ...
            l.forEach((function(t) {
                (function(t, e) {
                    ...
                    if (-1 !== e.indexOf(n))
                        return -1 === Jn.indexOf(n) || Boolean(t.nodeValue.match(Zn) || t.nodeValue.match(ti));
      ...
      , _i = function() {
        ...
        n.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                this.setContent(),
                this.config.animation && o.classList.add(hi);
                ...
                if (k(o, this.constructor.DATA_KEY, this),
                ...
                var h = function() {
                    ...
                    var e = t._hoverState;
                    t._hoverState = null,
                    F.trigger(t.element, t.constructor.Event.SHOWN),
                    e === gi && t._leave(null, t)
                };
        ...
        n.hide = function() {
            var t = this
              ...
              , n = function() {
                t._hoverState !== pi && e.parentNode && e.parentNode.removeChild(e),
                t._cleanTipClass(),
                t.element.removeAttribute("aria-describedby"),
                F.trigger(t.element, t.constructor.Event.HIDDEN),
                t._popper.destroy()
            };
            if (!F.trigger(this.element, this.constructor.Event.HIDE).defaultPrevented) {
                var i;
                if (e.classList.remove(di),
                "ontouchstart"in document.documentElement)
                ...
                this.tip.classList.contains(hi)) {
                    var o = p(e);
                    F.one(e, c, n),
                    v(e, o)
                } else
        ...
        n.setContent = function() {
            ...
            this.setElementContent(at.findOne(".tooltip-inner", t), this.getTitle()),
            t.classList.remove(hi, di)
        }
        ,
        n.setElementContent = function(t, e) {
            if (null !== t)
                ...
                t.appendChild(e)) : t.textContent = e.textContent)) : void (this.config.html ? (this.config.sanitize && (e = ni(e, this.config.whiteList, this.config.sanitizeFn)),
        ...
        n._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach((function(e) {
                if ("click" === e)
                    F.on(t.element, t.constructor.Event.CLICK, t.config.selector, (function(e) {
                        return t.toggle(e)
                    }
                    ));
                else if ("manual" !== e) {
        ...
        n._enter = function(t, e) {
            ...
            (e = e || O(t.delegateTarget, n)) || (e = new this.constructor(t.delegateTarget,this._getDelegateConfig()),
            k(t.delegateTarget, n, e)),
            t && (e._activeTrigger["focusin" === t.type ? vi : mi] = !0),
            e.getTipElement().classList.contains(di) || e._hoverState === pi ? e._hoverState = pi : (clearTimeout(e._timeout),
            e._hoverState = pi,
        ...
        n._getConfig = function(t) {
            ...
            "number" == typeof (t = o(o(o({}, this.constructor.Default), e), "object" == typeof t && t ? t : {})).delay && (t.delay = {
                show: t.delay,
                hide: t.delay
            }),
            "number" == typeof t.title && (t.title = t.title.toString()),
            "number" == typeof t.content && (t.content = t.content.toString()),
            _(ii, t, this.constructor.DefaultType),
            t.sanitize && (t.template = ni(t.template, t.whiteList, t.sanitizeFn)),
            t
        }
        ,
        ...
        n._fixTransition = function() {
            ...
            null === t.getAttribute("data-popper-placement") && (t.classList.remove(hi),
    ...
    if (bi) {
        ...
        bi.fn.tooltip = _i.jQueryInterface,
        bi.fn.tooltip.Constructor = _i,
        bi.fn.tooltip.noConflict = function() {
            return bi.fn.tooltip = yi,
            _i.jQueryInterface
        }
    }
    var wi = "popover"
      ...
      , Si = function(t) {
        ...
        r.setContent = function() {
            ...
            this.setElementContent(at.findOne(".popover-body", t), e),
    ...
    if (Ai) {
        ...
        Ai.fn.popover = Si.jQueryInterface,
        Ai.fn.popover.Constructor = Si,
        Ai.fn.popover.noConflict = function() {
            return Ai.fn.popover = xi,
            Si.jQueryInterface
        }
    }
    var Di = "scrollspy"
      ...
      , Yi = function() {
        function t(t, e) {
            ...
            this._config = this._getConfig(e),
            this._selector = this._config.target + " " + ".nav-link, " + this._config.target + " " + ".list-group-item, " + this._config.target + " ." + Ri,
            this._offsets = [],
            this._targets = [],
            this._activeTarget = null,
            this._scrollHeight = 0,
            F.on(this._scrollElement, "scroll.coreui.scrollspy", (function(t) {
                return n._process(t)
            }
            )),
            this.refresh(),
        ...
        return n.refresh = function() {
            ...
            at.find(this._selector).map((function(t) {
                var e = h(t)
                  , o = e ? at.findOne(e) : null;
                if (o) {
                    var r = o.getBoundingClientRect();
                    if (r.width || r.height)
                        return [bt[n](o).top + i, e]
                }
                return null
            }
            )).filter((function(t) {
        ...
        n._activate = function(t) {
            ...
            var e = this._selector.split(",").map((function(e) {
              ...
              , n = at.findOne(e.join(","));
            n.classList.contains(Ri) ? (at.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add(Mi),
            n.classList.add(Mi)) : (n.classList.add(Mi),
            at.parents(n, ".nav, .list-group").forEach((function(t) {
    ...
    if (Xi) {
        var Bi = Xi.fn[Di];
        Xi.fn[Di] = Yi.jQueryInterface,
        Xi.fn[Di].Constructor = Yi,
        Xi.fn[Di].noConflict = function() {
            return Xi.fn[Di] = Bi,
            Yi.jQueryInterface
        }
    }
   ...
   */
    ...
    function ao(t, e, n, i, o) {
        ...
        !function(t, e, n, i, o) {
            ...
            e && (f.dispatchEvent(so("ps-scroll-" + l)),
            e < 0 ? f.dispatchEvent(so("ps-scroll-" + c)) : e > 0 && f.dispatchEvent(so("ps-scroll-" + u)),
            i && function(t, e) {
                eo(t, e),
                no(t, e)
            }(t, l));
    ...
    function uo(t) {
        ...
        e.contains(t.scrollbarXRail) || (Ki(e, Ji.rail("x")).forEach((function(t) {
            return zi(t)
        }
        )),
        e.appendChild(t.scrollbarXRail)),
        e.contains(t.scrollbarYRail) || (Ki(e, Ji.rail("y")).forEach((function(t) {
            return zi(t)
        }
        )),
        ...
        t.scrollbarXWidth = fo(t, lo(t.railXWidth * t.containerWidth / t.contentWidth)),
        t.scrollbarXLeft = lo((t.negativeScrollAdjustment + e.scrollLeft) * (t.railXWidth - t.scrollbarXWidth) / (t.contentWidth - t.containerWidth))) : t.scrollbarXActive = !1,
        ...
        t.scrollbarYHeight = fo(t, lo(t.railYHeight * t.containerHeight / t.contentHeight)),
        t.scrollbarYTop = lo(n * (t.railYHeight - t.scrollbarYHeight) / (t.contentHeight - t.containerHeight))) : t.scrollbarYActive = !1,
        ...
        t.scrollbarXActive ? e.classList.add(Zi.active("x")) : (e.classList.remove(Zi.active("x")),
        t.scrollbarXWidth = 0,
        t.scrollbarXLeft = 0,
        e.scrollLeft = !0 === t.isRtl ? t.contentWidth : 0),
        t.scrollbarYActive ? e.classList.add(Zi.active("y")) : (e.classList.remove(Zi.active("y")),
    ...
    function ho(t, e) {
        ...
        function m() {
            no(t, c),
            t[u].classList.remove(Zi.clicking),
    ...
    var po = {
        ...
        "drag-thumb": function(t) {
            ho(t, ["containerWidth", "contentWidth", "pageX", "railXWidth", "scrollbarX", "scrollbarXWidth", "scrollLeft", "x", "scrollbarXRail"]),
            ho(t, ["containerHeight", "contentHeight", "pageY", "railYHeight", "scrollbarY", "scrollbarYHeight", "scrollTop", "y", "scrollbarYRail"])
        },
        keyboard: function(t) {
            var e = t.element;
            t.event.bind(t.ownerDocument, "keydown", (function(n) {
                if (!(n.isDefaultPrevented && n.isDefaultPrevented() || n.defaultPrevented) && (Vi(e, ":hover") || Vi(t.scrollbarX, ":focus") || Vi(t.scrollbarY, ":focus"))) {
                    ...
                    if (o) {
                        ...
                        if (Vi(i = o, "input,[contenteditable]") || Vi(i, "select,[contenteditable]") || Vi(i, "textarea,[contenteditable]") || Vi(i, "button,[contenteditable]"))
                            return
                    }
                    var r = 0
                      , s = 0;
        ...
        wheel: function(t) {
            ...
            function n(n) {
                var i = function(t) {
                  ...
                  , r = i[1];
                if (!function(t, n, i) {
                    if (!co.isWebKit && e.querySelector("select:focus"))
                        return !0;
                    if (!e.contains(t))
                        return !1;
                    for (var o = t; o && o !== e; ) {
                        if (o.classList.contains(Ji.consuming))
                            return !0;
                        var r = Ui(o);
                    ...
                    var s = !1;
                    t.settings.useBothWheelAxes ? t.scrollbarYActive && !t.scrollbarXActive ? (r ? e.scrollTop -= r * t.settings.wheelSpeed : e.scrollTop += o * t.settings.wheelSpeed,
                    s = !0) : t.scrollbarXActive && !t.scrollbarYActive && (o ? e.scrollLeft += o * t.settings.wheelSpeed : e.scrollLeft -= r * t.settings.wheelSpeed,
                    s = !0) : (e.scrollTop -= r * t.settings.wheelSpeed,
        ...
        touch: function(t) {
            if (co.supportsTouch || co.supportsIePointer) {
                var e = t.element
                  ...
                  , o = {}
                  , r = null;
                co.supportsTouch ? (t.event.bind(e, "touchstart", c),
                t.event.bind(e, "touchmove", u),
                t.event.bind(e, "touchend", f)) : co.supportsIePointer && (window.PointerEvent ? (t.event.bind(e, "pointerdown", c),
                ...
                if (l(r)) {
                    ...
                    function(n, i) {
                        var o = Math.floor(e.scrollTop)
                          ...
                          , a = Math.abs(i);
                        if (a > s) {
                            if (i < 0 && o === t.contentHeight - t.containerHeight || i > 0 && 0 === o)
                                return 0 === window.scrollY && i > 0 && co.isChrome
                        } else if (s > a && (n < 0 && r === t.contentWidth - t.containerWidth || n > 0 && 0 === r))
                            return !0;
                        return !0
            ...
            function f() {
                t.settings.swipeEasing && (clearInterval(r),
                r = setInterval((function() {
                    t.isInitialized ? clearInterval(r) : o.x || o.y ? Math.abs(o.x) < .01 && Math.abs(o.y) < .01 ? clearInterval(r) : (s(30 * o.x, 30 * o.y),
                    o.x *= .8,
      ...
      , go = function(t, e) {
        ...
        this.isRtl = "rtl" === Ui(t).direction,
        !0 === this.isRtl && t.classList.add(Gi),
        ...
        this.scrollbarXRail = Qi(Ji.rail("x")),
        t.appendChild(this.scrollbarXRail),
        this.scrollbarX = Qi(Ji.thumb("x")),
        ...
        this.scrollbarXTop = lo(l.top)) : this.isScrollbarXUsingBottom = !0,
        this.railBorderXWidth = lo(l.borderLeftWidth) + lo(l.borderRightWidth),
        qi(this.scrollbarXRail, {
            display: "block"
        }),
        this.railXMarginWidth = lo(l.marginLeft) + lo(l.marginRight),
        qi(this.scrollbarXRail, {
            display: ""
        }),
        this.railXWidth = null,
        this.railXRatio = null,
        this.scrollbarYRail = Qi(Ji.rail("y")),
        t.appendChild(this.scrollbarYRail),
        this.scrollbarY = Qi(Ji.thumb("y")),
        ...
        this.scrollbarYLeft = lo(c.left)) : this.isScrollbarYUsingRight = !0,
        ...
        this.railBorderYWidth = lo(c.borderTopWidth) + lo(c.borderBottomWidth),
        qi(this.scrollbarYRail, {
            display: "block"
        }),
        this.railYMarginHeight = lo(c.marginTop) + lo(c.marginBottom),
        qi(this.scrollbarYRail, {
            display: ""
        }),
    ...
    go.prototype.update = function() {
        ...
        this.railXMarginWidth = lo(Ui(this.scrollbarXRail).marginLeft) + lo(Ui(this.scrollbarXRail).marginRight),
        this.railYMarginHeight = lo(Ui(this.scrollbarYRail).marginTop) + lo(Ui(this.scrollbarYRail).marginBottom),
        qi(this.scrollbarXRail, {
            display: "none"
        }),
        qi(this.scrollbarYRail, {
    ...
    go.prototype.onScroll = function(t) {
        this.isAlive && (uo(this),
        ao(this, "top", this.element.scrollTop - this.lastScrollTop),
        ao(this, "left", this.element.scrollLeft - this.lastScrollLeft),
    ...
    go.prototype.destroy = function() {
        ...
        zi(this.scrollbarX),
        zi(this.scrollbarY),
        zi(this.scrollbarXRail),
        zi(this.scrollbarYRail),
      ...
      , Do = function() {
        ...
        return n.open = function(t) {
            ...
            F.one(this._element, c, (function() {
                ...
                F.trigger(e._element, "opened.coreui.sidebar"))
            }
            )),
            v(this._element, n)
        }
        ...
        n.close = function(t) {
            ...
            F.one(this._element, c, (function() {
                ...
                F.trigger(e._element, "closed.coreui.sidebar"))
            }
            )),
            v(this._element, n)
        }
        ...
        ,
        n.minimize = function() {
            this._isMobile() || (this._addClassName(Lo),
            this._minimize = !0,
            this._psDestroy())
        }
        ,
        n.unfoldable = function() {
            this._isMobile() || (this._addClassName(To),
            this._unfoldable = !0)
        }
        ,
        n.reset = function() {
            this._element.classList.contains(Lo) && (this._element.classList.remove(Lo),
            this._minimize = !1,
        ...
        n._getConfig = function(t) {
            return t = o(o(o({}, this.constructor.Default), bt.getDataAttributes(this._element)), t),
            _(mo, t, this.constructor.DefaultType),
            t
        }
        ,
        ...
        n._showBackdrop = function() {
            ...
            document.body.appendChild(this._backdrop),
            E(this._backdrop),
            this._backdrop.classList.add(Eo))
        }
        ,
        n._clickOutListener = function(t, e) {
            null === t.target.closest(xo) && (t.preventDefault(),
            t.stopPropagation(),
            e.close())
        }
        ,
        ...
        n._toggleDropdown = function(t, e) {
            ...
            "undefined" != typeof i.dropdownAccordion && (_o.dropdownAccordion = JSON.parse(i.dropdownAccordion)),
            !0 === _o.dropdownAccordion && this._getAllSiblings(n.parentElement, (function(t) {
            ...
            n.parentNode.classList.toggle(Eo),
            e._psUpdate()
        }
        ,
        n._psInit = function() {
        ...
        n._setActiveLink = function() {
            ...
            Array.from(this._element.querySelectorAll(So)).forEach((function(e) {
                ...
                "undefined" != typeof i.activeLinksExact && (_o.activeLinksExact = JSON.parse(i.activeLinksExact)),
                _o.activeLinksExact && e.href === n && (e.classList.add(yo),
                Array.from(t._getParents(e, Co)).forEach((function(t) {
                    t.classList.add(Eo)
                }
                ))),
                !_o.activeLinksExact && e.href.startsWith(n) && (e.classList.add(yo),
                Array.from(t._getParents(e, Co)).forEach((function(t) {
                    t.classList.add(Eo)
                }
                )))
        ...
        n._addEventListeners = function() {
            ...
            F.on(this._element, "classtoggle", (function(e) {
                if (e.detail.className === Lo && (t._element.classList.contains(Lo) ? t.minimize() : t.reset()),
                e.detail.className === To && (t._element.classList.contains(To) ? t.unfoldable() : t.reset()),
                "undefined" != typeof Object.keys(_o.breakpoints).find((function(t) {
    ...
    if (jo) {
        ...
        jo.fn.sidebar = Do.jQueryInterface,
        jo.fn.sidebar.Constructor = Do,
        jo.fn.sidebar.noConflict = function() {
            return jo.fn.sidebar = No,
            Do.jQueryInterface
        }
    }
    var Io = "coreui.tab"
      ...
      , Yo = function() {
        ...
        n._transitionComplete = function(t, e, n) {
            ...
            E(t),
            t.classList.contains(Ro) && t.classList.add(Mo),
            t.parentNode && t.parentNode.classList.contains("dropdown-menu")) && (t.closest(".dropdown") && at.find(".dropdown-toggle").forEach((function(t) {
    ...
    F.on(document, "click.coreui.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', (function(t) {
        t.preventDefault(),
        (O(this, Io) || new Yo(this)).show()
    }
    ));
    var Xo = L();
    if (Xo) {
        var Bo = Xo.fn.tab;
        Xo.fn.tab = Yo.jQueryInterface,
        Xo.fn.tab.Constructor = Yo,
        Xo.fn.tab.noConflict = function() {
            return Xo.fn.tab = Bo,
            Yo.jQueryInterface
        }
    }
    var Uo, qo, Qo, Fo, Vo, zo = "toast", Ko = "coreui.toast", $o = "." + Ko, Go = "click.dismiss" + $o, Jo = "hide", Zo = "show", tr = "showing", er = {
        animation: "boolean",
        autohide: "boolean",
        delay: "number"
    }, nr = {
        ...
        return n.show = function() {
            ...
            if (!F.trigger(this._element, "show.coreui.toast").defaultPrevented) {
                ...
                var e = function() {
                    t._element.classList.remove(tr),
                    t._element.classList.add(Zo),
                    F.trigger(t._element, "shown.coreui.toast"),
        ...
        n.hide = function() {
            ...
            if (this._element.classList.contains(Zo) && !F.trigger(this._element, "hide.coreui.toast").defaultPrevented) {
                var e = function() {
                    t._element.classList.add(Jo),
                    F.trigger(t._element, "hidden.coreui.toast")
                };
                if (this._element.classList.remove(Zo),
                this._config.animation) {
                    var n = p(this._element);
                    F.one(this._element, c, e),
                    v(this._element, n)
        ...
        n.dispose = function() {
            this._clearTimeout(),
            this._element.classList.contains(Zo) && this._element.classList.remove(Zo),
            F.off(this._element, Go),
            C(this._element, Ko),
            this._element = null,
            this._config = null
        }
        ,
        n._getConfig = function(t) {
            return t = o(o(o({}, nr), bt.getDataAttributes(this._element)), "object" == typeof t && t ? t : {}),
            _(zo, t, this.constructor.DefaultType),
            t
        }
        ,
        n._setListeners = function() {
    ...
    if (or) {
        var rr = or.fn.toast;
        or.fn.toast = ir.jQueryInterface,
        or.fn.toast.Constructor = ir,
        or.fn.toast.noConflict = function() {
            return or.fn.toast = rr,
            ir.jQueryInterface
        }
    }
    return Array.from || (Array.from = (Uo = Object.prototype.toString,
    qo = function(t) {
    ...
    ,
    "object" == typeof exports && "undefined" != typeof module ? Vo() : "function" == typeof define && define.amd ? define(Vo) : Vo(),
    function() {
        function t(t, e) {
            e = e || {
                bubbles: !1,
        ...
        "function" == typeof window.CustomEvent || this.CustomEvent.toString().indexOf("CustomEventConstructor") > -1 || (t.prototype = window.Event.prototype,
