    ...
    (function(global, factory) {
        ...
        helpers$1.extend(DatasetController.prototype, {
            ...
            _resolveDatasetElementOptions: function(element, hover) {
                ...
                for (i = 0,
                ilen = elementOptions.length; i < ilen; ++i) {
        ...
        function computeMinSampleSize(scale, pixels) {
            ...
            for (i = 0,
            ilen = scale.getTicks().length; i < ilen; ++i) {
        ...
        var controller_bar = core_datasetController.extend({
            ...
            getRuler: function() {
                ...
                var i, ilen;
                for (i = 0,
                ilen = me.getMeta().data.length; i < ilen; ++i) {
        ...
        core_defaults._set('doughnut', {
            ...
            legendCallback: function(chart) {
                ...
                if (datasets.length) {
                    for (i = 0,
                    ilen = datasets[0].data.length; i < ilen; ++i) {
        ...
        var controller_polarArea = core_datasetController.extend({
            ...
            update: function(reset) {
                ...
                for (i = 0,
                ilen = dataset.data.length; i < ilen; i++) {
                    starts[i] = start;
        ...
        function parseVisibleItems(chart, handler) {
            ...
            for (i = 0,
            ilen = metasets.length; i < ilen; ++i) {
                metadata = metasets[i].data;
                for (j = 0,
                jlen = metadata.length; j < jlen; ++j) {
                    element = metadata[j];
        ...
        function nonSkipped(ticksToFilter) {
            ...
            var item, index, len;
            for (index = 0,
            len = ticksToFilter.length; index < len; ++index) {
        ...
        function calculateSpacing(majorIndices, ticks, axisLength, ticksLimit) {
            ...
            for (i = 0,
            ilen = factors.length - 1; i < ilen; i++) {
                factor = factors[i];
                if (factor > spacing) {
                    return factor;
                }
        ...
        var Scale = core_element.extend({
            ...
            _autoSkip: function(ticks) {
                ...
                if (numMajorIndices > 0) {
                    for (i = 0,
                    ilen = numMajorIndices - 1; i < ilen; i++) {
        ...
        var scale_time = core_scale.extend({
            ...
            determineDataLimits: function() {
                ...
                for (i = 0,
                ilen = dataLabels.length; i < ilen; ++i) {
